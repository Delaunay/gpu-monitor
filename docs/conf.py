#!/usr/bin/env python
"""
gpusmi documentation build configuration file.
...
src_path = os.path.abspath(
    os.path.join(docs_src_path, "..", "gpusmi")
)
...
project = "gpusmi"
_full_version = gpusmi.core.__version__
author = gpusmi.core.__author__
copyright = gpusmi.core.__copyright__
